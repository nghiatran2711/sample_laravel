{{-- <form class="row g-3" action="{{ route('category.search') }}" method="GET">
    ...
    {{-- form search ajax --}}
<form class="row g-3" action="{{ route('admin.category.search_ajax_category') }}" method="GET" id="frm-search-category">
  <div class="col-auto">
    <label for="inputPassword2" class="visually-hidden">Password</label>
    <input type="text" name="category_name" class="form-control" id="category-name-search" placeholder="Category Name">
  </div><br>  
